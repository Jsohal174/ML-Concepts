...
helper_utils2.visualize_image(img, label)  # Display the image with its label
...
helper_utils2.visualize_image(img_transformed, label)
...
print("--- Train Loader --- \n")
helper_utils2.display_data_loader_contents(train_loader)
print("\n--- Test Loader --- \n")
helper_utils2.display_data_loader_contents(test_loader)
...
def train_epoch(model, loss_function, optimizer, train_loader, device, verbose=True):
    ...
    ### START CODE HERE ###
        ...
        predicted_indices = outputs.argmax(1)
...
class_accuracies = helper_utils2.evaluate_per_class(trained_model, test_loader, device)
...
message_imgs = helper_utils2.load_hidden_message_images()
