...
def objective_apples(trial, device):
    ...
    train_loader, val_loader = helper_utils3.get_apples_dataset_dataloaders(
        img_size=img_size,
    ...
    accuracy, precision, recall, f1 = helper_utils3.evaluate_metrics(
