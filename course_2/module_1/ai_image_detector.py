...
from helper_utils4 import evaluate_model, extract_attr, get_data_loaders, training_epoch

import helper_utils4
...
for split in ['train', 'test']:
    for category in ['real', 'fake']:
        helper_utils4.show_random_images(split, category, AIvsReal_path, num_images=5)
